...
namespace Assets.Scripts.Quests.Scenarios
{
    public class DestroyStatic_Quest : BaseQuest
    {
        ...
        [Inject]
        private void Construct(GameFactory gameFactory, CameraStateService cameraService, HitHandler hitHandler, QuestObjectsData questObjectsData)
        {
        ...
        {
            _gameFactory.PlayerKeeper.CharacterRefresher.Show(_playerInitPoint.position, _playerInitPoint.rotation);
